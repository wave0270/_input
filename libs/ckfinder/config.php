...
function CheckAuthentication()
{
	...
	return true; //mo khoa up hinh cua ckfinder
}
...
*/
//admore : duong dan folder ban muon add hinh
//$baseUrl = '/ckfinder/userfiles/';
$baseUrl = '/Aptana/Aptana Studio 3 Workspace/html5-new/BinhNT/Dropbox/Public/_TestChucNang/_siteInput/upload/';
/*
